...
with gr.Blocks(css=APP_CSS) as demo:
    ...
    gr.Markdown(
        ...
        <div class="intro-banner">
            <div class="intro-eyebrow">Live prediction arena</div>
            <h1>Battle of the Models</h1>
            <p><strong>Not all models think the same.</strong> Compare predictions across various models in real time.</p>
            <p>Pick an image and see where models agree &mdash; and where they fail.</p>
            <div class="model-arena">
                <span>ANN</span>
                <span>Optimized ANN</span>
                <span>Hyperparameterized ANN</span>
                <span>CNN</span>
                <span>ResNet18</span>
            </div>
            <div class="start-cue">Pick an image below and watch the scoreboard change.</div>
        </div>
        """
    )
